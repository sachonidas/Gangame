...
class ModelUnitTest {
    ...
    //Modelos de JSON esperado para poder hacer los test pertinentes
    ...
    fun topGameParsingTest(){
        ...
        Assert.assertEquals(topGame.thumb, "http://cdn.akamai.steamstatic.com/steam/apps/10/capsule_sm_120.jpg?t=1488471030")
